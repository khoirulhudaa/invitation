...
import Table from '../../../components/tableWDAdmin';
...
const Canteen = () => {
    ...
    const handleRemoveProduct = async (e: string) => {
        const response = await API.removeUser(e)
        ...
        <>
            <div className="panel">
                <div className="flex md:items-center md:flex-row flex-col mb-5 gap-5">
                    <h5 className="font-semibold text-lg dark:text-white-light">Data Pembayaran Kantin</h5>
