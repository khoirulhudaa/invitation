  ...
  return (
    <div className="relative ml-auto">
      ...
      <div
        ...
        className={`absolute right-0 mt-6 flex w-62.5 flex-col rounded-sm border border-stroke shadow-default dark:border-strokedark dark:bg-boxdark ${
          dropdownOpen === true ? "block" : "hidden"
        }`}
      >
        <button onClick={() => handleSignOut()} className="flex items-center gap-3.5 px-6 py-4 text-sm font-medium duration-300 rounded-lg shadow-lg ease-in-out bg-[red] text-white hover:brightness-[90%] lg:text-base">
          <svg
