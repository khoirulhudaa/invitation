                    ...
                    <div className="flex justify-between items-center px-4 py-3">
                        ...
                        >
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 m-auto">
                                <path d="M13 19L7 12L13 5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                <path opacity="0.5" d="M16.9998 19L10.9998 12L16.9998 5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                        </button>
                    </div>
                    <PerfectScrollbar className="h-[calc(100vh-80px)] relative">
                        <ul className="relative font-semibold space-y-0.5 p-4 py-5">
                            <li className="nav-item mb-6 text-white">
                                <ul>
                                    <li className="nav-item mb-6 text-white">
                                    ...
                                    <li className="nav-item mb-6 text-white">
                                        <NavLink to="/users" className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span className="ltr:pl-3 rtl:pr-3 text-white dark:text-[#506690] dark:group-hover:text-white-dark">{t('Pengguna')}</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                    <li className="nav-item mb-6 text-white">
                                        <NavLink to="/system-payment" className="group">
                                            <div className="flex items-center">
                                                <svg className="group-hover:!text-primary text-white" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        opacity="0.5"
                                                ...
                                                <span className="ltr:pl-3 rtl:pr-3 text-white dark:text-[#506690] dark:group-hover:text-white-dark">{t('Pembayaran')}</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                    ...
                                    <li className="nav-item mb-6 text-white">
                                        <NavLink to="/data-payment/canteen" className="group">
                                            <div className="flex items-center">
                                                <svg className="group-hover:!text-primary text-white" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                        opacity="0.5"
                                                ...
                                                <span className="ltr:pl-3 rtl:pr-3 text-white dark:text-[#506690] dark:group-hover:text-white-dark">{t('Kantin')}</span>
                                            </div>
                                        </NavLink>
                                    </li>
                                    <li className="nav-item mb-6 bg-white hover:brightness-[90%] hover:text-red-500 rounded-md cursor-pointer active:scale-[0.98]">
                                        <div className='px-3 py-[10px]' onClick={(e) => logOut(e)}>
                                            <div className="flex items-center">
                                                ...
                                                <span className="ltr:pl-3 rtl:pr-3 text-blue-500 dark:text-[#506690] dark:group-hover:text-white-dark">{t('Logout')}</span>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
